...
public class FrmIngreso extends javax.swing.JInternalFrame {
        ...
        modeloDetalles = new DefaultTableModel() {
            ...
            public Object getValueAt(int fila, int columna) {
                if (columna == 5) {
                    Double cantidad;
                    try {
                        cantidad = Double.parseDouble((String) getValueAt(fila, 3));
                    } catch (Exception e) {
                        cantidad = 1.0;
                    }
                    Double precio = Double.parseDouble((String) getValueAt(fila, 4));
    ...
    private void initComponents() {
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                .addComponent(btnVerIngreso, javax.swing.GroupLayout.PREFERRED_SIZE, 128, javax.swing.GroupLayout.PREFERRED_SIZE)))
                        .addContainerGap())))
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGap(34, 34, 34)
        ...
        jPanel2.add(txtIdProveedor, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 12, 57, -1));
        jPanel2.add(txtNombreProveedor, new org.netbeans.lib.awtextra.AbsoluteConstraints(175, 12, 190, -1));

        btnSelecionarProveedor.setText("...");
        btnSelecionarProveedor.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnSelecionarProveedorActionPerformed(evt);
            }
        });
        jPanel2.add(btnSelecionarProveedor, new org.netbeans.lib.awtextra.AbsoluteConstraints(383, 11, -1, -1));
        ...
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(tabGeneral, javax.swing.GroupLayout.DEFAULT_SIZE, 623, Short.MAX_VALUE)
        );
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        if (txtIdProveedor.getText().length() == 0) {
            ...
            btnSelecionarProveedor.requestFocus();
            return;
        }
    ...
    private void btnSelecionarProveedorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSelecionarProveedorActionPerformed
        FrmSelecionarProveedorCompra frm = new FrmSelecionarProveedorCompra(contenedor, this, true);
        frm.toFront();
    ...
    private void btnVerArituculosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVerArituculosActionPerformed
        FrmSelecionarArticuloCompra frm = new FrmSelecionarArticuloCompra(contenedor, this, true);
        frm.toFront();
    ...
    private void txtCodigoBarraKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtCodigoBarraKeyReleased
        if (txtCodigoBarra.getText().length() > 0) {
            if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
                ...
                art = this.CONTROL.obtenerAticuloCodigoIngreso(txtCodigoBarra.getText());
                if (art == null) {
