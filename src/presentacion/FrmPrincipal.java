...
public class FrmPrincipal extends javax.swing.JFrame {
    ...
    private void cargarOpcionesMenu(){
        if(negocio.Variables.rolNombre.equals("Administrador")){
            ...
            itemConsutaCompras.setEnabled(true);
            ...
            mnuVentas.setEnabled(true);
            mnuAcceso.setEnabled(false);
            itemConsutaCompras.setEnabled(false);
            itemConsultaVentas.setEnabled(true);
        }else{
        mnuAlmacen.setEnabled(false);
            mnuCompras.setEnabled(false);
    ...
    private void initComponents() {
        ...
        itemConsutaCompras = new javax.swing.JMenuItem();
        ...
        itemConsutaCompras.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_O, java.awt.event.InputEvent.ALT_DOWN_MASK));
        itemConsutaCompras.setText("Consultas Compras");
        mnuConsultas.add(itemConsutaCompras);
        ...
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(escritorio, javax.swing.GroupLayout.DEFAULT_SIZE, 374, Short.MAX_VALUE)
        );
    ...
    private void jMenuItem2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem2ActionPerformed
        FrmArticulo fmr = new FrmArticulo();
        escritorio.add(fmr);
        fmr.setVisible(true);
    ...
    private javax.swing.JMenuItem itemConsutaCompras;
